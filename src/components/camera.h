...
public:
    ...
    {
        mFov = glm::degrees(2.0f * atan(tan(glm::radians(horizontalFov) * 0.5f) / mAspectRatio));
        mProjectionCached = false;
    }
    ...
    virtual void getNearClipCoordinates(glm::vec3 *topLeft, glm::vec3 *topRight, glm::vec3 *bottomLeft,
    ...
    virtual void getFarClipCoordinates(glm::vec3 *topLeft, glm::vec3 *topRight, glm::vec3 *bottomLeft,
                                       glm::vec3 *bottomRight) const
    {
